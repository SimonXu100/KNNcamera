...
class Inception3Net{
    ...
    /**
         ...
         - Returns:
            A string with top-1 valid labels ready to be put in predictLabel
     */
    func getLabel(assetIndex: Int)->ObjectModel{
        ...
        // get top 1 valid guesses and add them to return string with top 1 guesses
        var returnString = ""

        let (prob, index) = indexedProbabilities[0]
        ...
        model.name = labels[index]
        model.prob = prob
        model.index = assetIndex
        return model
    }
